...
console.log("readout: every form the mark can take, and the question its hover asks");
{
  ...
  assert("the preference's box reads the visit", readout(forms.download, utterances, { remembered: true, metered: false }).remembered && !readout(forms.download, utterances, ASKING).remembered);
